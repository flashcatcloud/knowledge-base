...
description: "Synchronize OceanBase alert events to Flashcat Cloud via webhook for automated alert noise reduction"
date: "2024-05-23T10:00:00+08:00"
url: "https://docs.flashcat.cloud/en/flashduty/oceanbase-integration-guide"
---

Sync OceanBase alert events to Flashcat Cloud via webhook for automated alert noise reduction
...
|OceanBase|Flashcat Cloud|Status|
|---|---|---|
