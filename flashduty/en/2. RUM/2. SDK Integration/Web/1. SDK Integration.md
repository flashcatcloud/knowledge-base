...
url: "https://docs.flashcat.cloud/en/flashduty/rum/web-sdk-integration?nav=01JCQ7A4N4WRWNXW8EWEHXCMF5"
---
...
| allowedTracingUrls                  | Array                      | No       | List of request URLs for injecting tracing headers. For more information, see [Connect RUM and Traces](https://docs.flashcat.cloud/en/flashduty/rum/web-advanced-configuration#connect-rum-and-distributed-tracing)   |
