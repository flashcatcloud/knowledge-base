...
To set user information, see [Tracking User Information](https://docs.flashcat.cloud/en/flashduty/rum/web-sdk-integration#tracking-user-information).
...
| Attribute                | Type                 | Description                                                                                                                                                                  |
| ------------------------ | -------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `action.loading_time`    | Number (nanoseconds) | Action loading time. Calculation method in [Tracking User Actions documentation](https://docs.flashcat.cloud/en/flashduty/rum/web-sdk-integration#tracking-user-actions). |
...
For more information on privacy configuration, see [Advanced Configuration](https://docs.flashcat.cloud/en/flashduty/rum/web-advanced-configuration).

## More Information

- [Web SDK Integration](https://docs.flashcat.cloud/en/flashduty/rum/web-sdk-integration): Learn how to integrate Flashcat RUM SDK in Web apps
- [Web SDK Advanced Configuration](https://docs.flashcat.cloud/en/flashduty/rum/web-advanced-configuration): Learn how to configure advanced SDK features
- [RUM Data Collection](https://docs.flashcat.cloud/en/flashduty/rum/data-collection): Learn about RUM general data collection mechanism
