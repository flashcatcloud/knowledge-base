...
To set user information, see [Tracking User Information](https://docs.flashcat.cloud/en/flashduty/rum/sdk-integration#tracking-user-information).
...
| Attribute                | Type                 | Description                                                                                                                                                           |
| ------------------------ | -------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `action.loading_time`    | Number (nanoseconds) | Action loading time. Calculation method in [Tracking User Actions documentation](https://docs.flashcat.cloud/en/flashduty/rum/sdk-integration#tracking-user-actions). |
...
- [Web SDK Integration](https://docs.flashcat.cloud/en/flashduty/rum/sdk-integration): Learn how to integrate Flashcat RUM SDK in Web apps
