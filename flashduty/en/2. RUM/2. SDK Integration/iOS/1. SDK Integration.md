...
In the RUM [Application Management](https://console.flashcat.cloud/rum/apps) page of the Flashcat console:
...
- [Track iOS Errors](https://docs.flashcat.cloud/en/flashduty/rum/ios-error-event): Learn how to track and debug iOS errors
