...
To set user information, see [Tracking User Information](https://docs.flashcat.cloud/en/flashduty/rum/ios-sdk-integration#tracking-user-information).
...
- [iOS SDK Integration](https://docs.flashcat.cloud/en/flashduty/rum/ios-sdk-integration): Learn how to integrate Flashcat RUM SDK in iOS apps
- [iOS SDK Advanced Configuration](https://docs.flashcat.cloud/en/flashduty/rum/ios-advanced-configuration): Learn how to configure advanced SDK features
