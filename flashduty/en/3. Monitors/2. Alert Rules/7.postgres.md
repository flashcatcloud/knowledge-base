---
title: "PostgreSQL Alert Rule Configuration"
description: "This document provides detailed instructions on configuring alert rules for PostgreSQL data sources in Monitors. Monitors supports using standard SQL syntax to query PostgreSQL and trigger alerts based on query results."
date: "2025-12-30T18:21:50.775+08:00"
url: "https://docs.flashcat.cloud/en/flashduty/monitors/postgres-alert-rules"
---

This document provides detailed instructions on configuring alert rules for PostgreSQL data sources in Monitors. Monitors supports using standard SQL syntax to query PostgreSQL and trigger alerts based on query results.
...
- **Time handling**: It's recommended to use functions like `NOW()`, `CURRENT_TIMESTAMP` in SQL for time range filtering.
...
- **Pros**: Leverages PostgreSQL database computing power for filtering, reducing network transmission.
...
- Recommended: `log_time > NOW() - INTERVAL '5 minutes'`.

### Field case sensitivity

Monitors engine converts column names returned by PostgreSQL to lowercase.
