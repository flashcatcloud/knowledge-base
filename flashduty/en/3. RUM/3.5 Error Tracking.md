...
Watch recordings of user sessions where errors occurred to see exactly what the user was doing when the error happened. This helps you understand the context and reproduce the issue.
...
RumBrowser.addError('Payment processing failed', {
  source: 'custom',
  context: {
