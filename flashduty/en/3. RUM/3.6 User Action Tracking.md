...
RumBrowser.addAction('click', 'Add to Cart Button', {
  product_id: '12345',
...
```javascript
// Track a user flow
RumBrowser.addAction('flow_start', 'Checkout Process Started', {
  cart_value: 99.99,
  items_count: 3
});

// Later in the flow
RumBrowser.addAction('flow_step', 'Shipping Information Completed', {
  shipping_method: 'express'
});

// At the end of the flow
RumBrowser.addAction('flow_complete', 'Purchase Completed', {
  order_id: '67890',
...
RumBrowser.addAction('page_view', 'Product Details Page', {
  product_id: '12345',
...
FlashCat RUM's Session Replay feature allows you to watch recordings of user sessions, focusing on specific actions:
...
FlashCat RUM provides privacy controls to help you comply with regulations like GDPR and CCPA:
