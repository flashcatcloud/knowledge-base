...
Ensure you're using a supported browser. Flashduty RUM supports:
...
Flashduty RUM adds some debug commands to the browser console:
...
By following these troubleshooting steps, you can ensure that Flashduty RUM is properly configured and collecting the data you need to monitor and improve your web application's performance and user experience.
