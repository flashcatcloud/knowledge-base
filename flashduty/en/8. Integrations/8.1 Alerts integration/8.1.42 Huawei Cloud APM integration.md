...
**Note:** The current integration configuration only supports application monitoring alerts, and does not support front-end monitoring, link tracking, and App monitoring alerts.
</div>
