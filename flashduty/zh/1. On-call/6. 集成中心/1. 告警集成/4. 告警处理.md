...
![2025-12-17-15-53-19](https://docs-cdn.flashcat.cloud/images/png/517a537c48284c7b72d86262e7b855e7.png)

## 配置入口
---
进入 **集成中心** => 选择以创建的集成 => **告警处理** 页签。

![2025-12-17-15-54-33](https://docs-cdn.flashcat.cloud/images/png/e581fe9fc4ba1a505f0c47c7864c55ac.png)
...
- [配置标签增强](https://docs.flashcat.cloud/zh/flashduty/label-enrichment-settings) - 动态生成或修改告警标签
- [配置过滤条件](https://docs.flashcat.cloud/zh/flashduty/how-to-filter) - 了解条件匹配语法
- [配置静默与抑制](https://docs.flashcat.cloud/zh/flashduty/silence-and-inhibition) - 在协作空间层面抑制告警
