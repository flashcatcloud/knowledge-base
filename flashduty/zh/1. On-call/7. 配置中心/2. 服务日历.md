---
title: "配置服务日历"
description: "定义工作日和休息日，让分派策略和静默规则按日历自动生效"
...
- [配置分派策略](https://docs.flashcat.cloud/zh/flashduty/escalate-rule-settings) - 在分派策略中引用服务日历
- [配置静默规则](https://docs.flashcat.cloud/zh/flashduty/silence-and-inhibition) - 按日历类型静默告警
