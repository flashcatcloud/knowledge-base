...
您可以在应用配置-SDK 配置中修改参数来实时预览初始化 SDK 的代码，以便您快速接入 SDK，有关更多配置说明可见[初始化参数](https://docs.flashcat.cloud/zh/flashduty/rum/web-sdk-integration#初始化参数)
...
- [RUM SDK 接入指南](https://docs.flashcat.cloud/zh/flashduty/rum/web-sdk-integration)：了解如何接入 RUM SDK
