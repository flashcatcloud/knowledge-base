...
要自动追踪网络请求，请参考 [SDK 接入指南](https://docs.flashcat.cloud/zh/flashduty/rum/android-sdk-integration#步骤-5初始化拦截器以追踪网络事件) 中的 OkHttp 拦截器配置。
...
- [Android SDK 接入指南](https://docs.flashcat.cloud/zh/flashduty/rum/android-sdk-integration)：了解如何接入 Android RUM SDK
- [Android 数据收集](https://docs.flashcat.cloud/zh/flashduty/rum/android-data-collected)：了解 SDK 收集的数据类型和内容
