...
要设置用户信息,请参阅 [追踪用户信息](https://docs.flashcat.cloud/zh/flashduty/rum/web-advanced-configuration#%E7%94%A8%E6%88%B7%E4%BC%9A%E8%AF%9D)。
...
| 属性                     | 类型         | 描述                                                                              |
| ------------------------ | ------------ | --------------------------------------------------------------------------------- |
| `action.loading_time`    | 数字（纳秒） | 操作的加载时间。计算方式参见 [追踪用户操作文档](https://docs.flashcat.cloud/zh/flashduty/rum/web-sdk-integration#追踪用户操作)。 |
...
有关隐私配置的更多信息,请参阅 [高级配置](https://docs.flashcat.cloud/zh/flashduty/rum/web-advanced-configuration)。

## 更多信息

- [Web SDK 接入](https://docs.flashcat.cloud/zh/flashduty/rum/web-sdk-integration)：了解如何在 Web 应用中接入 Flashcat RUM SDK
- [Web SDK 高级配置](https://docs.flashcat.cloud/zh/flashduty/rum/web-advanced-configuration)：了解如何配置 SDK 的高级功能
- [RUM 数据收集](https://docs.flashcat.cloud/zh/flashduty/rum/data-collection)：了解 RUM 通用数据收集机制
