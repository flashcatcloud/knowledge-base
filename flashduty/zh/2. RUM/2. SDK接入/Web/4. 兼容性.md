...
- [Web SDK 接入指南](https://docs.flashcat.cloud/zh/flashduty/rum/web-sdk-integration)：了解如何集成 SDK
- [Web SDK 高级配置](https://docs.flashcat.cloud/zh/flashduty/rum/web-advanced-configuration)：了解 SDK 的高级配置选项
- [Web SDK 数据收集](https://docs.flashcat.cloud/zh/flashduty/rum/web-data-collected)：了解 SDK 收集哪些数据
