...
要设置用户信息，请参阅 [追踪用户信息](https://docs.flashcat.cloud/zh/flashduty/rum/ios-sdk-integration#追踪用户信息)。
...
- [iOS SDK 接入](https://docs.flashcat.cloud/zh/flashduty/rum/ios-sdk-integration)：了解如何在 iOS 应用中接入 Flashcat RUM SDK
