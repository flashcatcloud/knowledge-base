---
title: "iOS SDK 性能影响"
description: "本文档介绍 Flashcat iOS RUM SDK 对应用性能的影响。"
date: "2024-05-09T10:00:00+08:00"
url: "https://docs.flashcat.cloud/zh/flashduty/rum/ios-sdk-performance-impact"
---
...
SDK 初始化过程经过优化，对应用启动时间的影响控制在亚毫秒级。建议在 `AppDelegate` 的 `didFinishLaunchingWithOptions` 中尽早初始化 SDK，以便捕获完整的应用启动过程。
...
- [iOS SDK 接入指南](https://docs.flashcat.cloud/zh/flashduty/rum/ios-sdk-integration)：了解如何接入 SDK
...
- [iOS SDK 兼容性](https://docs.flashcat.cloud/zh/flashduty/rum/ios-supported-versions)：了解 SDK 支持的平台版本
