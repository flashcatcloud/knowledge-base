...
| proxy                      | Boolean                    | 否   | 可选代理 URL，例如：`https://www.proxy.com/path`。有关详细信息，请参阅完整的代理设置指南。                   |
...
| compressIntakeRequests     | Boolean                    | 否   | 压缩发送到 Datadog 入口的请求，以减少发送大量数据时的带宽使用。压缩是在 Worker 线程中完成的。默认值：`false` |
...
[SDK 高级配置][advancedConf]

[查看性能监控指标][performance]

[配置告警规则][errorTracking]

[untrustedEvents]: https://developer.mozilla.org/zh-CN/docs/Web/API/Event/isTrusted
[errorTracking]: https://docs.flashcat.cloud/zh/flashduty/rum/error-tracking/overview
[performance]: https://docs.flashcat.cloud/zh/flashduty/rum/performance-analysis
[advancedConf]: https://docs.flashcat.cloud/zh/flashduty/rum/advanced-configuration
