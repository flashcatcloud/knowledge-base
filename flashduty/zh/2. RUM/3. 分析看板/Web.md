...
1. **登录态用户识别**：对于需要用户登录的应用（如 SaaS 产品、会员系统、电商平台等），您可以参考[用户标识采集](https://docs.flashcat.cloud/zh/flashduty/rum/web-advanced-configuration#%E7%94%A8%E6%88%B7%E4%BC%9A%E8%AF%9D)
